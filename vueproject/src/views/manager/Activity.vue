<template>
    <div>
        <div class="search">
            <el-input placeholder="请输入比赛名称" style="width: 200px" v-model="name"></el-input>
        ...
        <div class="table">
            <el-table :data="tableData" strip @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="descr" label="赛事简介" show-overflow-tooltip></el-table-column>
                ...
                <el-table-column prop="form" label="比赛形式"></el-table-column>
                <el-table-column prop="address" label="比赛地址" show-overflow-tooltip></el-table-column>
                <el-table-column prop="host" label="主办方"></el-table-column>
                <el-table-column prop="readCount" label="浏览量"></el-table-column>
                <el-table-column label="内容">
                    <template v-slot="scope">
                        <el-button @click="preview(scope.row.content)">详情</el-button>
                    </template>
                </el-table-column>
        ...
        <el-dialog title="信息" :visible.sync="fromVisible" width="50%" :close-on-click-modal="false" destroy-on-close>
            <el-form :model="form" label-width="100px" style="padding-right: 50px" :rules="rules" ref="formRef">
                <el-form-item label="比赛名称" prop="name">
                    <el-input v-model="form.name" placeholder="比赛名称"></el-input>
                </el-form-item>
                <el-form-item label="赛事简介" prop="descr">
                    <el-input type="textarea" v-model="form.descr" placeholder="赛事简介"></el-input>
                </el-form-item>
                ...
                <el-form-item label="开始时间" prop="start">
                    <el-date-picker style="width: 100%" value-format="yyyy-MM-dd" format="yyyy-MM-dd"
                                    v-model="form.start" placeholder="开始时间"></el-date-picker>
                </el-form-item>
                <el-form-item label="结束时间" prop="end">
                    <el-date-picker style="width: 100%" value-format="yyyy-MM-dd" format="yyyy-MM-dd" v-model="form.end"
                                    placeholder="结束时间"></el-date-picker>
                </el-form-item>
                <el-form-item label="比赛形式" prop="form">
                ...
                <el-form-item label="比赛地址" prop="address">
                    <el-input v-model="form.address" placeholder="比赛地址"></el-input>
                </el-form-item>
        ...
        <el-dialog title="比赛详情" :visible.sync="fromVisible1" width="50%" :append-to-body="true" :close-on-click-modal="false" destroy-on-close>
            <div class="w-e-text">
